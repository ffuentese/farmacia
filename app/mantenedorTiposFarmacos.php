...
if (!isset($_SESSION['usuario']) | !$_SESSION['usuario']) {
    ...
    $contenido1 = '<p>Bienvenido al sistema de control de fármacos de El Muerto Sano</p>'
            . '<fieldset><legend>Nuevo Tipo de Fármaco</legend>'
            . '<form class="pure-form pure-form-stacked" action="../operadores/registrar_tipo.php" method="post">'
            . '<label for="descripcion">Descripción</label><input type="text" name="descripcion_tipo"  id="descripcion_tipo" onblur="validarDescripcionTipo(this)" /> '
