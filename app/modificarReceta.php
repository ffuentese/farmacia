...
if (!isset($_SESSION['usuario']) | !$_SESSION['usuario']) {
    ...
    $contenido1 = '<p>Bienvenido al sistema de control de fármacos de El Muerto Sano</p>'
            . '<fieldset><legend>Modificar Receta</legend>'
            ...
            . '<label for="fecha">Fecha</label><input type="text" name="fecha_emision"  id="fecha_emision" value="'.date('Y-m-d').'"/>'
   ...
   foreach ($lista_recetas as $result){
            $contenido2 .= '<tr>'
                    ...
                    . '<td><input type="submit" value="Modificar" /></form></td>'
                    . '</tr>';
   }
